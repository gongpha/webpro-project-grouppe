...
<div class="container">
	...
	<div class="d-flex gap-4">
		<div class="list-group" style="min-width: 250px;">
			<a href="course_edit.php?id=<?php echo isset($_GET['id']) ? $_GET['id'] : '0'; ?>" class="list-group-item list-group-item-action active">ข้อมูลคอร์ส</a>
			<?php if ($id != 0) { ?>
				<a href="course_statistics.php?id=<?php echo isset($_GET['id']) ? $_GET['id'] : '0'; ?>" class="list-group-item list-group-item-action ">สถิติ</a>
